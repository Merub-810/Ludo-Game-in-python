...
class Ludo:
    ...
    def board_set_up(self):
       ...
       # green star
        ...
        self.points = [common_x+5-2,common_y +20-2,common_x+20-2,common_y +20-2,common_x+25-2,common_y +5-2,common_x+30-2,common_y +20-2,common_x+45-2,common_y +20-2,common_x+32.5-2,common_y +30-2,common_x+37.5-2,common_y +45-2,common_x+25-2,common_y +35-2,common_x+12.5-2,common_y +45-2,common_x+17.7-2,common_y +30-2]
        self.make_canvas.create_polygon(self.points,fill="blue",width=4)
    ...
    def take_initial_control(self):
        ...
        head = Label(top,text="     LUDO with Computer",font=("Arial",25,"bold","italic"),bg="#141414",fg="white")
        ...
        mvc_btn = Button(top,text="Start",bg="#262626",fg="#00FF00",font=("Arial",15,"bold"),relief=RAISED,bd=3,command=lambda: operate(1), activebackground="#262626")
    ...
    def instruction_btn_red(self):
        self.red_hit_status=Label(self.make_canvas,text="Blocked",bg="#141414",fg="red",font=("Arial",8,"bold"))
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Roll dice", font=("Arial", 8, "bold"), command=lambda: self.make_prediction("red"))
        ...
        Label(self.make_canvas,text="Computer",bg="#141414",fg="gold",font=("Arial",10,"bold")).place(x=15,y=15+140+50)
        self.store_instructional_btn(block_predict_red,predict_red,[btn_1,btn_2,btn_3,btn_4])

    def instruction_btn_yellow(self):
        self.yellow_hit_status=Label(self.make_canvas,text="Blocked",bg="#141414",fg="red",font=("Arial",8,"bold"))
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Roll dice",font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        ...
        Label(self.make_canvas, text="You", bg="#141414", fg="gold", font=("Arial", 10, "bold")).place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 +7),y=15+(40*6+40*3)+40 + 110+50)
    ...
    def motion_of_coin(self,counter_coin,specific_coin,number_label,number_label_x ,number_label_y,color_coin,path_counter):
        try:
            ...
            while True:
                if path_counter == 0:
                    break
                elif (counter_coin == 51 and color_coin == "red")or (counter_coin == 25 and color_coin == "yellow") or counter_coin>=100:
                    if counter_coin<100:
                        counter_coin=100
                        ...
                        if process_forward:
                            ...
                            if take_ref:
                                for robo in temp_robo_store:#  robo is coin number
                                    for coin_other in take_ref:# coin_other is yellow coin location
...
if __name__ == '__main__':
    ...
    block_six_side = ImageTk.PhotoImage(Image.open("Images/dice6.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_five_side = ImageTk.PhotoImage(Image.open("Images/dice5.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_four_side = ImageTk.PhotoImage(Image.open("Images/dice4.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_three_side = ImageTk.PhotoImage(Image.open("Images/dice3.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_two_side = ImageTk.PhotoImage(Image.open("Images/dice2.jpeg").resize((33, 33), Image.ANTIALIAS))
    block_one_side = ImageTk.PhotoImage(Image.open("Images/dice1.jpeg").resize((33, 33), Image.ANTIALIAS))
